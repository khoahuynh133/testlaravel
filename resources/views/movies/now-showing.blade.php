        ...
        <div class="py-5 bg-light">
            <div class="container">
                ...
                <div class="text-center mb-5">
                    ...
                    <div class="mx-auto" style="width: 60px; height: 3px; background-color: #dc3545; border-radius: 2px;">
                    </div>
                    <p class="mt-3 text-muted w-75 mx-auto">
                        Khám phá những bộ phim hấp dẫn đang được trình chiếu tại rạp gần bạn.
                    </p>
                </div>
                ...
                @if ($movies->isEmpty())
                    <div class="text-center py-5">
                        ...
                        <h3 class="h5">Chưa có phim nào đang chiếu</h3>
                        <p class="text-muted mt-2">Hãy quay lại sau hoặc xem các phim sắp chiếu!</p>
                        <a href="{{ route('movies.coming-soon') }}" class="btn btn-danger mt-3 px-4">
                            Xem phim sắp chiếu
                        </a>
                    </div>
                @else
                            ...
                            <div class="col">
                                <div class="card h-100 border-0 shadow-sm rounded-3 overflow-hidden position-relative"
                                    ...
                                    <div class="position-relative" style="padding-bottom: 150%; background-color: #f8f9fa;">
                                        ...
                                        <!-- Nhãn trạng thái -->
                                        <span class="position-absolute top-2 start-2 badge bg-danger">
                                            ĐANG CHIẾU
                                        </span>
                                    </div>
                                    ...
                                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center"
                                        ...
                                        <button class="btn btn-light fw-bold rounded-pill px-4 shadow">
                                            MUA VÉ
                                        </button>
                                    </div>
                                </div>
